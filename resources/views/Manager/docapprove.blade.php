...
<div class="az-content az-content-dashboard">
  <div class="container">
    ...
    <h3 style="float:left; margin:0;">Document Approval</h3>
</div>
      ...
      <hr class="mg-y-30">
          ...
          <div class="table-responsive">
            <table class="table table-striped mg-b-0" id="usersTable">
              ...
              <tbody>
                @foreach($pendingApprovalDocument as $key => $doc)
                <tr>
                  <th scope="row">{{ ++$key }}</th>
                  ...
                  <td>
                    ...
                    @if($doc->manager_approval_id == '')
                    <button class="btn btn-success apv" data-id="{{ $doc->document_id }}">Approve</button>
                    <button class="btn btn-danger rej" data-id="{{ $doc->document_id }}">Reject</button>
                    @endif
