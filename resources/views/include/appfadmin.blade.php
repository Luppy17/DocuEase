    ...
    <div class="az-header-menu">
      ...
      <ul class="nav">
        <li class="nav-item @if($page == 'dashboard') active @endif">
          <a href="/dashboard-fileadmin" class="nav-link"><i class="typcn typcn-chart-area-outline"></i> Dashboard</a>
        </li>
        <li class="nav-item @if($page == 'docapproval') active @endif">
          <a href="/docupdaproval" class="nav-link"><i class="typcn typcn typcn-input-checked"></i> Document Upload Approval</a>
        </li>
        <li class="nav-item @if($page == 'docviewapproval') active @endif">
          <a href="/docviewapproval" class="nav-link"><i class="typcn typcn typcn-dropbox"></i> Document Viewing Approval</a>
        </li>
        <li class="nav-item @if($page == 'department-documents') active @endif">
            <a href="/department-documents" class="nav-link"><i class="typcn typcn typcn-user"></i> Department Documents</a>
          </li>
      </ul>
    </div>
