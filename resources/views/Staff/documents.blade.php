        ...
        <div class="container">
            <div class="az-content-body">
                ...
                <div class="mb-4 clearfix">
                    <h3 class="float-left">My Drive</h3>
                    <button class="btn btn-primary float-right" id="uploadFileBtn">Upload File</button>
                    <button class="btn btn-secondary float-right mr-2" id="createFolderBtn">Create Folder</button>
                </div>
...
<script>
    $(function(){
        ...
        if (searchInput.length) { // Check if search input exists on the page
