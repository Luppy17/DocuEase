...
<style>
  ...
  .rejected-item:hover {
    ...
    box-shadow: 0 12px 40px rgba(229, 62, 62, 0.2) !important;
    cursor: not-allowed;
  }
        ...
        <div class="container">
            <div class="az-content-body">
                ...
                <div class="mb-4 clearfix">
                    <h3 class="float-left" style="color: #2d3748; font-weight: 600;">Rejected Documents</h3>
                </div>
                ...
                <div id="driveItemsContainer" class="drive-container">
                    ...
                    <div class="drive-item file-item rejected-item">
                        <div class="icon-wrapper">
                            <i class="fa fa-file fimg rejected-icon" data-id="{{ $doc->document_id }}"></i>
                        </div>
                    ...
                    <div class="col-12 text-center py-5">
                        <div style="opacity: 0.6;">
                            <i class="fas fa-times-circle" style="font-size: 64px; color: #e53e3e; margin-bottom: 24px;"></i>
                            <h4 style="color: #2d3748; font-weight: 600; margin-bottom: 12px;">No rejected documents found</h4>
                            <p style="color: #4a5568; font-size: 16px;">All your documents have been approved or are pending review.</p>
                        </div>
                    </div>
                    @endforelse
                </div>
...
<script>
    $(function(){
        ...
        if (currentPage === 'rejected-files') {
            $('.az-sidebar-nav .nav-link[href="/rejected-files"]').addClass('active');
        } else if (currentPage) {
        ...
        // File Actions (for non-rejected files)
        ...
        // Rejected Files Click Handler
        $('.rejected-item').click(function(e) {
            e.preventDefault();
            e.stopPropagation();
            
            Swal.fire({
                title: 'Document Rejected',
                text: 'This document has been rejected and cannot be viewed or modified.',
                icon: 'error',
        ...
        // Delete Actions (for non-rejected files)
        ...
        // Rename Actions (for non-rejected files)
        ...
        // File Upload/Edit (for non-rejected files)
        let editMode = false;
        ...
        // Enhanced Star Functionality (for non-rejected files)
